...
You can start using Linkedin directly from [agentr.dev](https://agentr.dev). Visit [agentr.dev/apps](https://agentr.dev/apps) and enable Linkedin.
...
The full list of available tools is at [Tools](./src/universal_mcp_linkedin/README.md)
